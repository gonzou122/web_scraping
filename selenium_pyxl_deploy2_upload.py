...
# Excelファイルの読み込み
file_path = 'C:/Users/hogehoge.xlsx'
...
# Webドライバーの読み込み
driver = webdriver.Chrome('C:/Users/chromedriver.exe',chrome_options=options) # WebDriverのインスタンスを作成 pathを指定
driver.get('hogehoge.com') # URLを指定してブラウザを開く
time.sleep(1.5) # 2秒待機
# APMROのログイン情報の変数を入力
user_id = 'hogehoge'
